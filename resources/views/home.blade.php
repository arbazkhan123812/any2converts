...
function openTool(toolId) {
    ...
    const isEditorTool = toolId === 'edit_pdf' || toolId === 'sign_pdf';
...
function getToolName(toolId) {
    const names = {
        ...
        'image_converter':'Image Converter','video_to_audio':'Video to Audio','video_compressor':'Video Compressor','crop_image':'Crop Image','ai_image_generator':'AI Image Generator','ocr_tool':'OCR Tool',
